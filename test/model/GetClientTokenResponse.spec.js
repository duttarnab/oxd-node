...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OxdServer.GetClientTokenResponse();
  });
  ...
  describe('GetClientTokenResponse', function() {
    it('should create an instance of GetClientTokenResponse', function() {
      // uncomment below and update the code to test GetClientTokenResponse
      //var instance = new OxdServer.GetClientTokenResponse();
      //expect(instance).to.be.a(OxdServer.GetClientTokenResponse);
    });
