...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OxdServer.GetTokensByCodeResponse();
  });
  ...
  describe('GetTokensByCodeResponse', function() {
    it('should create an instance of GetTokensByCodeResponse', function() {
      // uncomment below and update the code to test GetTokensByCodeResponse
      //var instance = new OxdServer.GetTokensByCodeResponse();
      //expect(instance).to.be.a(OxdServer.GetTokensByCodeResponse);
    });
    ...
    it('should have the property idTokenClaims (base name: "id_token_claims")', function() {
      // uncomment below and update the code to test the property idTokenClaims
      //var instance = new OxdServer.GetTokensByCodeResponse();
      //expect(instance).to.be();
    });
