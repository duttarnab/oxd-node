...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OxdServer.UmaRsProtectParams();
  });
  ...
  describe('UmaRsProtectParams', function() {
    it('should create an instance of UmaRsProtectParams', function() {
      // uncomment below and update the code to test UmaRsProtectParams
      //var instance = new OxdServer.UmaRsProtectParams();
      //expect(instance).to.be.a(OxdServer.UmaRsProtectParams);
    });
