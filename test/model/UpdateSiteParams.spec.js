...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OxdServer.UpdateSiteParams();
  });
  ...
  describe('UpdateSiteParams', function() {
    it('should create an instance of UpdateSiteParams', function() {
      // uncomment below and update the code to test UpdateSiteParams
      //var instance = new OxdServer.UpdateSiteParams();
      //expect(instance).to.be.a(OxdServer.UpdateSiteParams);
    });
