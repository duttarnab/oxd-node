...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OxdServer.GetUserInfoParams();
  });
  ...
  describe('GetUserInfoParams', function() {
    it('should create an instance of GetUserInfoParams', function() {
      // uncomment below and update the code to test GetUserInfoParams
      //var instance = new OxdServer.GetUserInfoParams();
      //expect(instance).to.be.a(OxdServer.GetUserInfoParams);
    });
